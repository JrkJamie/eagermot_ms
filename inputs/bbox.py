...
from utils.transform.transformation import to_homogeneous, inverse_rigid_transform
import utils.transform.nuscenes as nu_transform
...
class Bbox3d(ProjectsToCam):
    ...
    def __init__(self, bbox_coordinates, instance_id=None,
        ...
        if corners_3d_yaw is None:
            ...
            self.corners_3d = utils_geometry.compute_box_3d(bbox_coordinates[0], bbox_coordinates[1],
                                                            bbox_coordinates[2],
                                                            bbox_coordinates[4], bbox_coordinates[5],
                                                            bbox_coordinates[6],
    ...
    def from_nu_box_convert(cls, bbox_nu: Box, instance_id=None) -> "Bbox3d":
        ...
        return cls(coordinates_expected, instance_id,
                   ...
                   seg_class_id=reporting.id_from_name(detection_name))
